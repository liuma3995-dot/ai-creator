"""
百度千帆图片生成（V2 OpenAI 兼容协议）

2026 千帆 ModelBuilder V2 接口完全兼容 OpenAI 标准，单 API Key
（bce-v3/ALTAK-xxx 格式），旧 oauth token + rpc 协议已废弃。
"""
...
class BaiduImageGenerator(ImageGeneratorBase):
    ...
    def __init__(
        ...
        default_model: Optional[str] = "ernie-4.5-turbo-128k",
        **kwargs
    ):
        super().__init__(api_key, api_base, default_model, **kwargs)
        self.base_url = api_base or "https://qianfan.baidubce.com/v2"
    ...
    def get_supported_models(self) -> List[str]:
        return ["ernie-4.5-turbo-128k", "ernie-4.5-8k"]
