    ...
    fields: [
      {
        ...
        type: 'input',
        required: false,
        placeholder: '可选：一句话主题（不填则由预设内容驱动）',
        maxLength: 100,
      },
      {
        name: 'preset_content',
        ...
        type: 'textarea',
        required: true,
        placeholder: '必填：客户基础信息 + 大致拍摄方向/内容要点（代运营前采素材可整段粘贴），作为脚本最高优先级的事实基础',
        rows: 8,
        maxLength: 5000,
      },
      {
      ...
      },
      {
        ...
        type: 'select',
        required: false,
        placeholder: '可选：不选则由 AI 根据风格自由发挥',
        options: [
          { label: '成本型', value: '成本型' },
          { label: '人群型', value: '人群型' },
          { label: '猎奇型', value: '猎奇型' },
      ...
      },
      {
        ...
        options: [
          ...
          { label: '聊观点', value: '聊观点' },
          { label: '讲故事', value: '讲故事' },
          { label: '影视飓风', value: '影视飓风' },
          { label: '薛辉', value: '薛辉' },
          { label: '何同学', value: '何同学' },
          { label: '房琪Kiki', value: '房琪Kiki' },
        ],
      },
      additionalDescriptionField,
    ],
